...
class startPage(wx.Frame):
    ...
    def __init__(self, parent, title):
        super(startPage, self).__init__(parent, title=title, size=(450, 350))
    ...
    def InitUI(self):
        ...
        sizer.Add(st0, pos=(0,2), span=(1,3), flag=wx.EXPAND|wx.TOP|wx.ALIGN_CENTER|wx.BOTTOM, border=10)

        stl1 = wx.StaticLine(panel)
        sizer.Add(stl1, pos=(1,0), span=(1,5), flag=wx.EXPAND|wx.BOTTOM)

        st1 = wx.StaticText(panel, label='choose file path')
        ...
        st2 = wx.StaticText(panel, label='choose file path')
        ...
        st3 = wx.StaticText(panel, label='choose file path')
